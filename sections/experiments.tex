...
\begin{table}[h!]
	...
	\begin{tabular}{c|ccccc}
		...
		\midrule
		{\color{blue}2,000} & 230.5 &     284.4 & 297.9 &                            18.9 &                  53.9 \\
		{\color{blue}4,000} & 254.7 &     311.6 & 333.5 &                            18.3 &                  57.0 \\
		{\color{blue}6,000} & 268.6 &     327.4 & 354.5 &                            18.0 &                  58.8 \\
		{\color{blue}8,000} & 279.1 &     339.2 & 369.6 &                            17.7 &                  60.1 \\
		{\color{blue}10,000} & 287.1 &     347.7 & 380.7 &                            17.4 &                  60.6 \\
		\bottomrule
	\end{tabular}
