...
\newcommand{\Nt}[1]{P_{#1}(t)} % macro for notation of number of pulls up to but not including t
\newcommand{\Ntg}[2]{P_{#1}(#2)} % macro for notation of number of pulls up to but not including t
\newcommand{\hM}{\hat{M}}
\newcommand{\hS}{\hat{S}}
\newcommand{\hU}{\hat{U}}
\newcommand{\hV}{\hat{V}}
...
\and Eli Gutin \\ Uber Technologies, Inc. \\ email: \url{gutin@uber.com}}
\date{}
