...
\begin{document}
	...
	\begin{enumerate}
		...
		\item \textbf {Lemma 2:} 
		{\color{blue}: TODO: It seems like the poof of Fact 1 needs a tweak -- those functions are not differentiable. Perhaps you need to be thinking about sub-differentials?}	
